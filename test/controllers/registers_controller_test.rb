...
class RegistersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post registers_url, params: { register: { address: @register.address, image: @register.image, introduction: @register.introduction, price: @register.price, room_name: @register.room_name } }
    end
  ...
  test "should update register" do
    patch register_url(@register), params: { register: { address: @register.address, image: @register.image, introduction: @register.introduction, price: @register.price, room_name: @register.room_name } }
